---
title: How You Can Help Fix Peer Review
date: 2023-09-19
lastmod: 2023-09-19
---
...
The scant evidence available certainly does not suggest that we assign *accepts* and *rejects* objectively. In experiments by the NeurIPS conference in 2014 and again in 2021, half of the works selected for acceptance by one set of peer reviewers were rejected by parallel sets of reviewers.[^consistency] It's fashionable to refer to this inconsistency as *randomness*, but doing so presumes that our reviewing errors are unbiased and that their impact diminishes over the span of a career.[^delegitimizes] Biases can grow, becoming systemic. For example, a bias against underrepresented researchers, or against those willing to challenge popular ideas, would reduce the likelihood that young scientists in these categories to survive long enough in their careers to become reviewers themselves.[^selection-of-scientists]
...
{{< fedicomments url="https://mastodon.social/@MildlyAggrievedScientist/111092414807575448" exclude="" include="" >}}
