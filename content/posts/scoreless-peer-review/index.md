...
The scant evidence available certainly does not suggest that we assign *accepts* and *rejects* objectively. In experiments by the NeuroIPS conference in 2014 and again in 2021, half of the works selected for acceptance by one set of peer reviewers were rejected by parallel sets of reviewers.[^consistency] It's fashionable to refer to this inconsistency as *randomness*, but doing so promotes the belief that our reviewing errors are unbiased and that their impact diminishes over the span of a career. Systemic biases grow worse over time, as underrepresented researchers and those challenging popular ideas are more likely to face rejections unrelated to the scientific validity of their work, and are thus less likely to survive in their careers long enough to become reviewers themselves.[^selection-of-scientists]
...
[^evaluations]: Faculties and research labs could make hiring and promotion decisions, without counting publications, by using letters of support from others in the candidates' field, reading the scientific discourse that comments on and cites the candidates' research, reading the candidates' research itself, and/or watching that research presented. This is not too radically different from what institutions already do, but it does remove the pretense of objectivity that comes from counting publications.
