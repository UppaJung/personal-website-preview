...
(() => {
  ...
  var renderComments = (comments, originalPosterAccount) => {
    ...
    for (const comment of comments) {
      ...
      const avatarPicture = constructElement2("picture", {
        classes: ["comment-authors-avatar"],
        children: [avatarSource, avatarImg]
      });
      const avatarLink = constructElement2("a", {
        classes: ["comment-authors-avatar-link"],
        attributes: {
      ...
      const headerElement = constructElement2("header", {
        classes: ["comment-header", ...isOriginalPoster ? ["original-poster"] : []],
      ...
      const footerElement = constructElement2("footer", {
        classes: ["comment-footer", ...isOriginalPoster ? ["original-poster"] : []],
        children: [
          counters,
          originalStatusLink,
          timestamp
  ...
  var renderAccount = (account) => {
    ...
    const avatarImg = constructElement3("img", {
      ...
      attributes: {
        ...
        alt: "".concat(account.display_name, " (@").concat(account.username, "@").concat(accountsHostName, ") avatar")
      }
    });
    ...
    const avatarAnchor = constructElement3("a", {
      ...
      attributes: {
        href: account.url,
        rel: "external nofollow",
        title: "".concat(account.display_name, " (@").concat(account.username, "@").concat(accountsHostName, ")")
      },
      children: [avatarPicture]
    });
    return avatarAnchor;
